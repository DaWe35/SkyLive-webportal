...
body { 
	...
	background: -webkit-radial-gradient(0% 100%, ellipse cover, rgba(104,128,138,.4) 10%,rgba(138,114,76,0) 40%), linear-gradient(to bottom,  rgba(57,173,219,.25) 0%,rgba(42,60,87,.4) 100%), linear-gradient(135deg,  #251314 0%,#092756 100%);
...
<div class="login">
	<h1>Register</h1>
	<p class="text-secondary">Accounts will be recorded on blockchain later, but now you can register an ugly centralized account here:</p>
    <form method="post" action="register">
    	<input type="text" name="name" placeholder="Username or channel name" required="required" />
